...
Requires Core Alembic revision >= 20260701_0026.
"""
...
MIN_CORE_MIGRATION_REVISION = os.environ.get("FAIR_CRM_MIN_CORE_MIGRATION", "20260701_0026")
...
def load_fair_crm_permission_ids(cur) -> dict[str, str]:
    ...
    if not rows:
        raise SeedError(
            ...
            "Apply migration 20260701_0026_fair_crm_product_permissions first."
        )
