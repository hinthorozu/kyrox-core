"""Seed notifications.platform.send and notifications.platform.read permissions.
...
down_revision: Union[str, Sequence[str], None] = "20260701_0023"
...
PERMISSION_CODES = (
    ("notifications.platform.send", "Send organization notifications"),
    ("notifications.platform.read", "Read notification delivery status"),
)
...
def upgrade() -> None:
    ...
    if group_id is None:
        ...
        connection.execute(
            ...
            {
                "id": str(group_id),
                "code": "notifications.platform",
                "name": "Platform Notifications",
                "module": "notifications",
                "description": "Platform notification permissions",
                "sort_order": 10,
                "is_system": True,
            },
        )
