"""Seed fair_crm.mail_templates.* permissions for FAIR CRM product integration.

Revision ID: 20260701_0027
...
revision: str = "20260701_0027"
down_revision: Union[str, Sequence[str], None] = "20260701_0026"
...
PERMISSION_CODES: tuple[tuple[str, str], ...] = (
    ("fair_crm.mail_templates.read", "Read CRM mail templates"),
