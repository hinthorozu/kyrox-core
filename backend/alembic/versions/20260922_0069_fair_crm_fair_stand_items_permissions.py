"""Add SYSTEM-scoped Fair Stand item-record admin permissions.

Revision ID: 20260922_0069
Revises: 20260922_0068
"""
...
revision = "20260922_0069"
down_revision = "20260922_0068"
branch_labels = None
depends_on = None
...
SYSTEM_SCOPE = "system"
PERMISSIONS = (
    ("fair_crm.admin.fair_stand.items.read", "Read Fair Stand item records and satellites"),
    ("fair_crm.admin.fair_stand.items.create", "Create Fair Stand item records"),
    ("fair_crm.admin.fair_stand.items.update", "Update Fair Stand item records and satellites"),
    ("fair_crm.admin.fair_stand.items.archive", "Archive Fair Stand item records"),
)
                ...
                sa.text(
                    ...
                    VALUES
                        (:id, :code, 'FAIR CRM Fair Stand Admin', 'fair_crm',
                         'SYSTEM Super Admin Fair Stand catalog, preview, settings, and item administration', 96, TRUE,
        ...
        connection.execute(
            sa.text(
                ...
                SET name='FAIR CRM Fair Stand Admin',
                    module='fair_crm',
                    description='SYSTEM Super Admin Fair Stand catalog, preview, settings, and item administration',
                    sort_order=96,
                    is_system=TRUE,
