...
class CreateOrganizationUseCase:
    ...
    def execute(self, command: CreateOrganizationCommand) -> CreateOrganizationResult:
        ...
        # Validate that the platform user still exists and can authenticate,
        # but do NOT create an organization membership or assign an
        # organization-scoped role. Super Admin access is platform-level via
        # identity_users.is_super_admin and is independent of memberships/RBAC.
