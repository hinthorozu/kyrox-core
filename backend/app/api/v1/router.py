...
from app.modules.identity.api.organization.admin_routes import router as identity_admin_organization_router
...
api_v1_router.include_router(identity_admin_organization_router)
