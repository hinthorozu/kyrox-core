...
def _settings_api_root() -> Path:
    return Path(__file__).resolve().parents[3] / "app" / "modules" / "settings" / "api"
...
def test_settings_api_thin_modules_have_no_forbidden_imports() -> None:
    root = _settings_api_root()
