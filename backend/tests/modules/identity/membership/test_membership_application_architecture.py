...
APPLICATION_FILES = (
    "accept_membership_invite.py",
    "invite_member.py",
    "list_organization_memberships.py",
...
def test_membership_application_modules_do_not_import_outer_layers() -> None:
