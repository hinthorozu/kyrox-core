...
INFRASTRUCTURE_FILES = (
    ...
    "persistence/mappers/organization_mapper.py",
)
...
def test_infrastructure_organization_modules_do_not_import_application_or_api() -> None:
...
def test_infrastructure_organization_repository_does_not_define_save() -> None:
