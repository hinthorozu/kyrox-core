...
def _infrastructure_authentication_root() -> Path:
    return (
...
def test_infrastructure_authentication_has_no_forbidden_imports() -> None:
    root = _infrastructure_authentication_root()
