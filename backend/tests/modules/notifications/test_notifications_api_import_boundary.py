...
def _notifications_api_root() -> Path:
    return Path(__file__).resolve().parents[3] / "app" / "modules" / "notifications" / "api"
...
def test_notifications_api_thin_modules_have_no_forbidden_imports() -> None:
    root = _notifications_api_root()
