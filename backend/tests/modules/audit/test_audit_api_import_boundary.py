...
def _audit_api_root() -> Path:
    return Path(__file__).resolve().parents[3] / "app" / "modules" / "audit" / "api"
...
def test_audit_api_thin_modules_have_no_forbidden_imports() -> None:
    root = _audit_api_root()
